...
const Home = () => {
  ...
  return (
    <Carousel afterChange={onChange}>
      <div>
        <Image src='/images/image1.jpg' width={0} height={0} style={{ width: '100%', height: '100px' }}/>
        <Card.Body>
      ...
      <div>
      <Image src='/images/image2.jpg' width={0} height={0} style={{ width: '100%', height: '100px' }}/>
        <Card.Body>
      ...
      <div>
      <Image src='/images/image3.jpg' width={0} height={0} style={{ width: '100%', height: '100px' }}/>
        <Card.Body>
